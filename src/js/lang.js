var langs = {
    'kr': {
        teamDescription: 'Agile Team은 민첩하고, 유연하며, 생각을 빠르게 실행에 옮기는 스타트업 팀입니다. 팀의 목표는 세상을 좋은 방향으로 변화시킬 가치 있는 플랫폼을 만들고, 이를 통해 사람들을 연결함으로써 새로운 가치를 창출할 준비가 되어있습니다.',
        dongjun: '8년차 Javascript 멀티플랫폼 풀스택 개발자',
        hansoo: '세계적 관점으로 빠르게 움직이는 리서처이자 마케터',
    ...
    'en': {
        ...
        dongjun: 'Javascript multiplatform full-stack developer with 8 years+ of experience',
        hansoo: 'A fast-moving researcher and marketer with the global perspective',
